...
public class Comentario {
    ...
    // identificadores da publicação a que este comentário pertence
    ...
    // ----------------------------------------------------------------
    // Métodos estáticos (mesma estrutura da classe Publicacao)
    // ----------------------------------------------------------------

    /** Adicionar um comentário a uma publicação específica */
    ...
    /** Exibir todos os comentários de uma publicação */
        ...
        if (comentarios.isEmpty()) {
            ...
            for (Comentario c : comentarios) {
                System.out.println(i + ". [" + c.getAutorUsername() + "]: "
                    + c.getConteudo() + "  (" + c.getDataEnvio() + ")");
                i++;
            }
        }
    }

    /** Eliminar um comentário próprio */
    public static void eliminarComentario() {
        // mostra apenas os comentários do utilizador actual
        ArrayList<Comentario> meus = GestorComentario.procurarMeusComentarios(
            Menu.utiActual.getUsername()
        );
        ...
        System.out.println("Qual comentário quer eliminar?");
        int pos = Menu.input.nextInt();
        Menu.input.nextLine(); // limpar buffer

        ArrayList<Comentario> novos = GestorComentario.deletarComentario(
            Menu.utiActual.getUsername(), pos
        );
        GestorComentario.reescreverComentarios(novos);
